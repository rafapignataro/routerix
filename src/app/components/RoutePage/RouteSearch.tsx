...
export function RouteSearch() {
  ...
  return (
    <form onSubmit={handleFormSubmit} className="w-full max-w-[480px]">
      <label htmlFor="search-input" className="flex items-center p-2 gap-2 border-[1px] border-gray-200 rounded-md w-full max-w-[480px] bg-gray-50 relative">
